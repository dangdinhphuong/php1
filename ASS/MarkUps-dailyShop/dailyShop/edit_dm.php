						...
						<table>
							<thead>
								<form action="" method="post" enctype="multipart/form-data">
									<input type="hidden" name="cate_id" id="" value="<?= $result['cate_id'] ?>">
									<tr>
										<th>cate_name</th>
										<td><input type="text" placeholder="cate_name" name="cate_name" value="<?= $result['cate_name'] ?>"></td>
									</tr>
									<tr>
										<th>cate_image</th>
										<td><input type="file" name="cate_image" id="">
									...
									<tr>
										...
										<td><input type="text" placeholder="description" name="description" value="<?= $result['description'] ?>"></td>
									</tr>
