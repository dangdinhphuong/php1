...
<html lang="en">
  ...
  <section id="aa-catg-head-banner">
   <img src="https://thegioidohoa.com/wp-content/uploads/2015/10/thiet-ke-banner-an-tuong-cho-web-thoi-trang.jpeg" alt="fashion img">
              ...
              <div class="row">
                  ...
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <div class="simpleLens-big-image-container"><a  class="simpleLens-lens-image"> <div class="simpleLens-big-image-container"><a class="simpleLens-lens-image"><img src="../images/<?= $product['pro_image'] ?>" alt=""class="simpleLens-big-image"width="250" height="300"></a></div></a></div>
                      </div>
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <label class="aa-product-price" style="color: red;  font-size: 30px; " >$<?= $product['price'] ?> <del style="color: black;  font-size: 20px;"> $ <?= $product['price_start'] ?></del></label>  
                      <p class="aa-product-avilability"><?= $product['intro'] ?></p>
      ...
      <div class="modal-content">
        <div class="modal-body">
          ...
          <form class="aa-login-form" action="login.php" method="post">
            ...
            <input type="text" placeholder="Username or email" name="usersname">
